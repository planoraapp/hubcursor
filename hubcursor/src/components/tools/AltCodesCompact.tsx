    ...
    <div className="bg-white rounded-lg shadow-md p-4">
      ...
      <div className="grid grid-cols-2 gap-2 mb-4">
        {habboAltCodes.slice(0, 8).map((altCode, index) => (
          <div
            key={index}
            className="bg-gray-50 border border-gray-200 rounded p-2 hover:bg-gray-100 transition-colors cursor-pointer"
            onClick={() => openModal(altCode)}
            title={`${altCode.character} - ${altCode.description}`}
          >
            <img 
      ...
      <div className="text-center">
        <Button 
          ...
          className="volter-font text-sm bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded"
        >
              ...
              <div className="grid grid-cols-3 gap-3">
                {habboAltCodes.map((altCode, index) => (
                  <div
                    ...
                    onClick={() => setSelectedAltCode(altCode)}
                  >
                    <div className="text-center">
