                ...
                <>
                  ...
                  {activities.map((activity, index) => (
                    <div key={`${activity.username}-${activity.timestamp}-${index}`} className="space-y-3">
                      {/* Activity Card */}
                      <div className="flex items-start gap-2 px-1 py-2 rounded-lg bg-white/5 hover:bg-white/10 transition-colors">
                        ...
                        <div className="flex-1 min-w-0">
                          <button
                            ...
                            className="font-semibold text-white hover:text-blue-300 transition-colors text-left block"
                          >
                            {activity.username}
                          </button>
                        ...
                        {activity.hotel && (
                          <div className="text-xs text-white/40 bg-white/10 px-2 py-1 rounded flex-shrink-0">
                            .{activity.hotel}
                          </div>
                        )}
                      </div>
