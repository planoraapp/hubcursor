...
const TamagotchiCompact = () => {
  ...
  // Pets disponíveis - foco no macaco primeiro
  const pets = [
    {
      id: 'monkey',
      name: '🐒 Macaco',
      emoji: '🐒',
      // Imagem real do macaco do Habbo
      imageUrl: 'https://habboxwiki.com/images/pets/monkey.png',
      // URLs alternativas para testar
      alternativeUrls: [
        'https://habboxwiki.com/images/pets/monkey.png',
        'https://www.habbowidgets.com/images/pets/monkey.png',
        'https://habboemotion.com/images/pets/monkey.png',
        'https://images.habbo.com/dcr/hof_furni/pets/monkey.png'
      ]
    },
    {
      id: 'dog',
      name: '🐕 Cachorro',
      emoji: '🐕',
      imageUrl: 'https://habboxwiki.com/images/pets/dog.png',
      alternativeUrls: [
        'https://habboxwiki.com/images/pets/dog.png',
        'https://www.habbowidgets.com/images/pets/dog.png'
      ]
    },
    {
      id: 'cat',
      name: ' Gato',
      emoji: '🐱',
      imageUrl: 'https://habboxwiki.com/images/pets/cat.png',
      alternativeUrls: [
        'https://habboxwiki.com/images/pets/cat.png',
        'https://www.habbowidgets.com/images/pets/cat.png'
      ]
    },
    {
      id: 'bear',
      name: ' Urso',
      emoji: '🐻',
      imageUrl: 'https://habboxwiki.com/images/pets/bear.png',
      alternativeUrls: [
        'https://habboxwiki.com/images/pets/bear.png',
        'https://www.habbowidgets.com/images/pets/bear.png'
      ]
    },
    {
      id: 'dragon',
      name: '🐉 Dragão',
      emoji: '🐉',
      imageUrl: 'https://habboxwiki.com/images/pets/dragon.png',
      alternativeUrls: [
        'https://habboxwiki.com/images/pets/dragon.png',
        'https://www.habbowidgets.com/images/pets/dragon.png'
      ]
    }
  ];
  ...
  const getPetImage = () => {
    ...
    return currentPetData.imageUrl;
  };
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              <div className="volter-font text-xs text-gray-600 text-center space-y-1">
                ...
                <p><strong>🐒 Macaco:</strong> Imagem real do Habbo!</p>
              </div>
            </div>
          </div>
        </DialogContent>
