        ...
        <SidebarInset>
          ...
          >
            <div className="max-w-7xl mx-auto space-y-6">
              <PageBanner
                title="Fontes Volter Goldfish Oficiais"
                subtitle="Demonstração das 3 variações da fonte pixelada do Habbo Hotel"
              />
