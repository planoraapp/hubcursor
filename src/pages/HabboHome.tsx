...
const HabboHome: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg font-semibold text-gray-700">Carregando Habbo Home...</p>
          <p className="text-sm text-gray-500">de {username}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Título da página fora do container */}
      <div className="bg-white shadow-sm border-b p-4">
        <h1 className="text-2xl font-bold text-center text-gray-800">
          HabboHub Home - {habboData.name}
        </h1>
      </div>
          ...
          <div className="relative" style={{ minHeight: '800px' }}>
            ...
            >
              <div className="w-full h-full flex flex-col">
                <h3 className="font-bold text-gray-800 mb-4">🎵 Traxplayer</h3>
            ...
            >
              <div className="w-full h-full text-center">
                <h3 className="font-bold text-gray-800 mb-4">⭐ Avaliação</h3>
